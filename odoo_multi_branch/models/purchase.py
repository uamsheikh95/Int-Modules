...
class PurchaseOrder(models.Model):
	...
	partner_id = fields.Many2one('res.partner', string='Vendor', required=True, states=READONLY_STATES,
	 ...
	 help="You can find a vendor by its Name, TIN, Email or Internal Reference.",domain = lambda self: ['|',('company_branch_id', '=',self.env.user.company_branch_id.id),('company_branch_id', '=',False)])
