...
class SalesByItemDetailReport(models.AbstractModel):
    ...
    # @api.model
    def _lines(self, date_from, date_to, company_id, product, company_branch_id): #, company_branch_id
        full_move = []
        params = [date_from, date_to, company_id, product, company_branch_id] #, company_branch_id
        ...
        query = """
            ...
            and sr.product_id=%s and sr.invoice_status <> 'no' and sr.state NOT IN ('draft', 'cancel', 'sent') and sr.company_branch_id=%s
