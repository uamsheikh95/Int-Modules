...
#         return self.env.ref('account_customer_statement.action_report_partnerledger').report_action(self, data=data)
    ...
    def action_statement_send(self):
        ...
        for o in partners:
            ...
            <table style="font-family: arial, sans-serif; border-collapse: collapse; width: 100%;border-top: 1px solid#ddd;border-bottom: 1px solid#ddd;">
              <thead>
                  <tr>
                	...
                	<th style="border: 1 px solid #dddddd; text-align: left; padding: 8px;">Debit</th>
                	<th style="border: 1 px solid #dddddd; text-align: left; padding: 8px;">Credit</th>
                	<th style="border: 1 px solid #dddddd; text-align: left; padding: 8px;">Balance</th>
                  </tr>
              </thead>
              ...
              <tbody>
                <tr>
    				<td colspan='7'>
						<strong>""" + o.ref if  o.ref else '' + """</strong>""" + """- <strong>""" + o.name + """</strong>
    				</td>
        		</tr>"""
            ...
            if date_from:
                ...
                body_html = body_html + """<tr>
                    ...
                    <td>
                        <p><strong>""" + str(balance_forward) + """</strong></p>
                    </td>
                </tr>"""
                #str(balance_forward)
        ...
        body_html = body_html + "</tbody></table>"
