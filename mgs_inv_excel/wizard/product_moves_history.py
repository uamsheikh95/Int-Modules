...
class ProductMovesHistory(models.TransientModel):
    _inherit = 'mgs_inv.pr_moves_history'
    _description = 'Product Moves History Excel Print Add'

    @api.model
    def print_xls_report(self, data):
        return self.env['report'].get_action(self,
                                             report_name='mgs_inv.report_product_moves_history_xlsx.xlsx')
...
class ProductMovesHistoryXLSX(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, obj):
        ...
        worksheet = workbook.add_worksheet('pr_moves_history_report.xlsx')
        ...
        worksheet.merge_range('A1:J2', 'Product Moves History', heading_format)
...
ProductMovesHistoryXLSX('report.mgs_inv.report_product_moves_history_xlsx.xlsx', 'mgs_inv.pr_moves_history')
