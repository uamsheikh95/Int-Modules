...
class ReportPartnerLedger_statement(models.AbstractModel):
    ...
    def _lines(self, data, partner):
        ...
        query = """
            ...
            WHERE "account_move_line".partner_id = %s
                ...
                ORDER BY "account_move_line".date,"account_move_line".move_id"""
    ...
    def _get_invoice(self, invoice_number):
        return self.env['account.invoice'].search([('number','=',invoice_number)],limit=1)
    ...
    def render_html(self, doc_ids, data):
        ...
        return self.env['report'].render('account_customer_statement.report_partnerledger', docargs)
